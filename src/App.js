...
class UploadData extends Component {
  ...
  componentWillMount() {
    ...
    const { OPTC1, OPTC2, OPT1, OPT2, OPT3, OPT4, OPT5, OPT6, OPT7, OPT8, OPT9, OPT10, OPT11, OPT12, OPT13, OPT14, OPT15, OPT16, OPT17, OPT18, OPT19, OPT20, OPT21, OPT22, OPT23, OPT24, OPT25, OPT26, OPT27, OPT28} = steps;

    this.setState({ OPTC1, OPTC2, OPT1, OPT2, OPT3, OPT4, OPT5, OPT6, OPT7, OPT8, OPT9, OPT10, OPT11, OPT12, OPT13, OPT14, OPT15, OPT16, OPT17, OPT18, OPT19, OPT20, OPT21, OPT22, OPT23, OPT24, OPT25, OPT26, OPT27, OPT28 });
  }

  render() {
    const { OPTC1, OPTC2, OPT1, OPT2, OPT3, OPT4, OPT5, OPT6, OPT7,  OPT8, OPT9, OPT10, OPT11, OPT12, OPT13, OPT14, OPT15, OPT16, OPT17, OPT18, OPT19, OPT20, OPT21, OPT22, OPT23, OPT24, OPT25, OPT26, OPT27, OPT28 } = this.state;
    
    if(OPTC1.value !='No' && OPTC2.value != 'No')
    uploadFeedback('Yes', OPT1.value, OPT2.value, OPT3.value, OPT4.value, OPT5.value, OPT6.value, OPT7.value,  OPT8.value, OPT9.value, OPT10.value, OPT11.value, OPT12.value, OPT13.value, OPT14.value, OPT15.value, OPT16.value, OPT17.value, OPT18.value, OPT19.value, OPT20.value, OPT21.value, OPT22.value, OPT23.value, OPT24.value, OPT25.value, OPT26.value, OPT27.value, OPT28.value);
...
const form = [
  ...
  },
  {
    id: 'OPT1',
    options: [
      { value: '18-24', label: '18-24', trigger: 'Q2' },
      { value: '25-34', label: '25-34', trigger: 'Q2' },
      { value: '35-44', label: '35-44', trigger: 'Q2' },
      { value: '45-54', label: '45-54', trigger: 'Q2' },
      { value: '55-64', label: '55-64', trigger: 'Q2' },
    ],
  },
  {
    id: 'Q2',
  ...
  },
  {
    id: 'OPT2',
    options: [
      { value: 'Rarely', label: 'Rarely', trigger: 'Q3' },
      { value: 'Occasionally', label: 'Occasionally', trigger: 'Q3' },
      { value: 'Frequently', label: 'Frequently', trigger: 'Q3' },
      { value: 'Almost always', label: 'Almost always', trigger: 'Q3' },
    ],
  },
  {
    id: 'Q3',
  ...
  },
  {
    id: 'OPT3',
    options: [
      { value: 'Clear privacy policy', label: 'Clear privacy policy', trigger: 'Q4' },
      { value: 'Reputation of the company', label: 'Reputation of the company', trigger: 'Q4' },
      { value: 'Positive reviews from other users', label: 'Positive reviews from other users', trigger: 'Q4' },
      { value: 'Secure payment options', label: 'Secure payment options', trigger: 'Q4' },
      { value: 'All of the above', label: 'All of the above', trigger: 'Q4' },
      { value: 'None of the above', label: 'None of the above', trigger: 'Q4' },
    ],
  },
  {
    id: 'Q4',
  ...
  },
  {
    id: 'OPT4',
    options: [
      { value: 'Completely trust', label: 'Completely trust', trigger: 'Q5' },
      { value: 'Somewhat trust', label: 'Somewhat trust', trigger: 'Q5' },
      { value: 'Do not trust', label: 'Do not trust', trigger: 'Q5' },
      { value: 'Not applicable', label: 'Not applicable', trigger: 'Q5' },
    ],
  },
  {
    id: 'Q5',
  ...
  },
  {
    id:'OPT9',
    options:[
      { value: 'Use of encryption', label: 'Use of encryption', trigger: 'Q10' },
      { value: 'Two-factor authentication', label: 'Two-factor authentication', trigger: 'Q10' },
      { value: 'Compliance with industry standards', label: 'Compliance with industry standards', trigger: 'Q10' },
      { value: 'None of the above', label: 'None of the above', trigger: 'Q10' },
    ],
  },
  {
    id: 'Q10',
  ...
  },
  {
    id:'OPT10',
    options:[
      { value: 'Yes', label: 'Yes', trigger: 'Q11' },
      { value: 'No', label: 'No', trigger: 'Q11' },
    ],
  },
  {
    id: 'Q11',
  ...
  },
  {
    id:'OPT11',
    options:[
      { value: 'Very likely', label: 'Very likely', trigger: 'Q12' },
      { value: 'Somewhat likely', label: 'Somewhat likely', trigger: 'Q12' },
      { value: 'Not very likely', label: 'Not very likely', trigger: 'Q12' },
      { value: 'Not at all likely', label: 'Not at all likely', trigger: 'Q12' },
    ],
  },
  {
    id: 'Q12',
  ...
  },
  {
    id:'OPT12',
    options:[
      { value: 'Very Important', label: 'Very Important', trigger: 'Q13' },
      { value: 'Somewhat important', label: 'Somewhat important', trigger: 'Q13' },
      { value: 'Not very important', label: 'Not very important', trigger: 'Q13' },
      { value: 'Not at all important', label: 'Not at all important', trigger: 'Q13' },
    ],
  },
  {
    id: 'Q13',
  ...
  },
  {
    id:'OPT13',
    options:[
      { value: 'Password requirement', label: 'Password requirement', trigger: 'Q14' },
      { value: 'Two-factor authentication', label: 'Two-factor authentication', trigger: 'Q14' },
      { value: 'Security Questions', label: 'Security Questions', trigger: 'Q14' },
      { value: 'All of the above', label: 'Not at all important', trigger: 'Q14' },
      { value: 'None of the above', label: 'None of the above', trigger: 'Q14' },
    ],
  },
  {
    id:'Q14',
  ...
  },
  {
    id:'OPT14',
    options:[
      { value: 'Very Important', label: 'Very Important', trigger: 'Q15' },
      { value: 'Somewhat important', label: 'Somewhat important', trigger: 'Q15' },
      { value: 'Not very important', label: 'Not very important', trigger: 'Q15' },
      { value: 'Not at all important', label: 'Not at all important', trigger: 'Q15' },
    ],
  },
  {
    id:'Q15',
  ...
  },
  {
    id: 'OPT17',
    options: [
      { value: 'Completely trust', label: 'Completely trust', trigger: 'Q18' },
      { value: 'Somewhat trust', label: 'Somewhat trust', trigger: 'Q18' },
      { value: 'Do not trust', label: 'Do not trust', trigger: 'Q18' },
      { value: 'Not applicable', label: 'Not applicable', trigger: 'Q18' },
    ],
  },
  {
    id:'Q18',
  ...
  },
  {
    id:'OPT19',
    options:[
      { value: 'Very Important', label: 'Very Important', trigger: 'Q20' },
      { value: 'Somewhat important', label: 'Somewhat important', trigger: 'Q20' },
      { value: 'Not very important', label: 'Not very important', trigger: 'Q20' },
      { value: 'Not at all important', label: 'Not at all important', trigger: 'Q20' },
    ],
  },
  {
    id:'Q20',
  ...
  },
  {
    id:'OPT20',
    options:[
      { value: 'Yes', label: 'Yes', trigger: 'Q21' },
      { value: 'No', label: 'No', trigger: 'Q21' },
      { value: 'Maybe', label: 'Maybe', trigger: 'Q21' },
    ],
  },
  {
    id:'Q21',
  ...
  },
  {
    id:'OPT23',
    options:[
      { value: 'Very Important', label: 'Very Important', trigger: 'Q24' },
      { value: 'Somewhat important', label: 'Somewhat important', trigger: 'Q24' },
      { value: 'Not very important', label: 'Not very important', trigger: 'Q24' },
      { value: 'Not at all important', label: 'Not at all important', trigger: 'Q24' },
    ],
  },
  {
    id:'Q24',
  ...
  },
  {
    id:'OPT25',
    options:[
      { value: 'Yes', label: 'Yes', trigger: 'Q26' },
      { value: 'No', label: 'No', trigger: 'Q26' },
      { value: 'Maybe', label: 'Maybe', trigger: 'Q26' },
    ],
  },
  {
    id:'Q26',
...
function uploadFeedback(CONSENT,OPT1, OPT2, OPT3, OPT4, OPT5, OPT6, OPT7, OPT8, OPT9, OPT10, OPT11, OPT12, OPT13, OPT14, OPT15, OPT16, OPT17, OPT18, OPT19, OPT20, OPT21, OPT22, OPT23, OPT24, OPT25, OPT26, OPT27, OPT28) {
  fetch('http://localhost:3001/createfeedback', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
    body: JSON.stringify({CONSENT,OPT1, OPT2, OPT3, OPT4, OPT5, OPT6, OPT7,  OPT8, OPT9, OPT10, OPT11, OPT12, OPT13, OPT14, OPT15, OPT16, OPT17, OPT18, OPT19, OPT20, OPT21, OPT22, OPT23, OPT24, OPT25, OPT26, OPT27, OPT28}),
  })
    .then(response => {
